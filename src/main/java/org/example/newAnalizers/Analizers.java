...
public class Analizers {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Parser();
        //
        System.out.println("\u001B[32m" + "El programa es aceptado." + "\u001B[0m");
    }
    ...
    public static void Parser() throws IOException {
        System.out.println("\u001B[32m" + "Parser Iniciado ... " + "\u001B[0m");
        /* Start analizer */
        ...
        while (token != null) {
            ...
            System.out.println("Token actual: " + currentToken);
        ...
        /* End analizer */
        System.out.println("\u001B[32m" + "Parser Finalizado." + "\u001B[0m");
    }
    ...
    private static String getAction(int state, String token) {
        ...
        throwError(token, "Token { " + token + " } not valid");
        return null;
    }
